import numpy as np
from RL_Models.models.RL import Agent
...
if __name__ == '__main__':
	...
	# agent.actor.checkpoint_file = "./tmp/gsw-ppo/actor_torch_ppo.pth"
	# agent.critic.checkpoint_file = "./tmp/gsw-ppo/critic_torch_ppo.pth"
